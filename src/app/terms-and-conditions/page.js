  ...
  return (
    <div className="my-10 space-y-5 text-gray-500">
      <p className="text-test font-bold text-2xl mx-2 md:mx-10 lg:mx-40">
        Terms and Conditions for Joy K Multiservices
      </p>
      <hr className="w-full h-2 " />
      <div className="my-10 mx-2 md:mx-10 lg:mx-40 space-y-5">
        <p className="text-test font-bold text-4xl ">Terms and Conditions</p>
        ...
        <p className="text-test font-bold text-4xl ">
          Interpretation and Definitions
        </p>

        <p className="text-test font-bold text-2xl ">Interpretation</p>
        ...
        <p className="text-test font-bold text-2xl ">Definitions</p>
        ...
        <ul className=" mx-8 space-y-5 list-disc">
          ...
          <li>
            <span className="text-test font-semibold">Country </span>
            refers to: Senegal
          </li>
          <li>
            <span className="text-test font-semibold">Company </span>
            (referred to as either &quot;the Company&quot;, &quot;We&quot;,
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Joy K
            Multiservices, 116 Cite Sonatel Zac Mbao, Dakar-Senegal.
          </li>
          <li>
            <span className="text-test font-semibold">Device </span>
            means any device that can access the Service such as a computer, a
            cellphone or a digital tablet.
          </li>
          <li>
            <span className="text-test font-semibold">Service </span>
            refers to the Website.
          </li>
          <li>
            <span className="text-test font-semibold">
          ...
          <li>
            <span className="text-test font-semibold">Website </span>
            refers to Joy K Multiservices, accessible from{" "}
            <a
              target="_blank"
          ...
          <li>
            <span className="text-test font-semibold">You </span>
        ...
        <p className="text-test font-bold text-4xl ">Acknowledgment</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Links to Other Websites</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Termination</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Limitation of Liability</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Governing Law</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Disputes Resolution</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Severability and Waiver</p>
        <p className="text-test font-bold text-2xl ">Severability</p>
        <p>
        ...
        <p className="text-test font-bold text-2xl ">Waiver</p>
        <p>
        ...
        <p className="text-test font-bold text-4xl ">Contact Us</p>
        <p>
          If you have any questions about these Terms and Conditions, You can
          contact us:
        </p>
        <ul className="mx-8 space-y-5 list-disc">
          <li>By email: joykmultiservices@gmail.com</li>
          <li>
