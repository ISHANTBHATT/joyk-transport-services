  ...
  return (
    <div className="my-10 space-y-5 text-gray-500">
      <p className="text-test font-bold text-2xl mx-2 md:mx-10 lg:mx-40">
        Privacy Policy for Joy K Multiservices
      </p>
      <hr className="w-full h-2 " />
      <div className="my-10 mx-2 md:mx-10 lg:mx-40 space-y-5">
        <p className="text-test font-bold text-4xl ">Privacy Policy</p>
        ...
        <ul className=" mx-8 space-y-5 list-disc">
          <li>
            <span className="text-test font-semibold">Account </span>
          ...
          <li>
            <span className="text-test font-semibold">Personal </span>
          ...
          <li>
            <span className="text-test font-semibold">Service Provider </span>
          ...
          <li>
            <span className="text-test font-semibold">Usage Data </span>
        ...
        <p className="text-test font-bold text-2xl ">Types of Data Collected</p>

        <p className="text-test font-bold text-xl ">Personal Data</p>
        <p>
        ...
        <p className="text-test font-bold text-xl ">
        ...
        <ul className="mx-8 space-y-5 list-disc">
          ...
          <li>
            <span className="text-test font-semibold">Web Beacons. </span>
        ...
        <ul className="mx-8 space-y-5 list-disc">
          ...
          <li>
            <span className="text-test font-semibold">With Affiliates: </span>
          ...
          <li>
            <span className="text-test font-semibold">With other users: </span>
          ...
          <li>
            <span className="text-test font-semibold">With Your consent: </span>
        ...
        <p className="text-test font-bold text-xl ">Business Transactions</p>
        <p>
        ...
        <p className="text-test font-bold text-xl ">Law enforcement</p>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <p className="text-test font-bold text-xl ">Other legal requirements</p>
        <p>
        ...
        <p className="text-test font-bold text-2xl ">Links to Other Websites</p>
        <p>
