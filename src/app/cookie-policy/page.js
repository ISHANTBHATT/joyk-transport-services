  ...
  return (
    <div className="my-10 space-y-5 text-gray-500">
      <p className="text-test font-bold text-2xl mx-2 md:mx-10 lg:mx-40">
        Cookies Policy for JOY K MultiServices
      </p>
      <hr className="w-full h-2 " />
      <div className="my-10 mx-2 md:mx-10 lg:mx-40 space-y-5">
        <p className="text-test font-bold text-4xl ">Cookies Policy</p>
        ...
        <p>
          ...
          help of the Cookies Policy Generator.
        </p>
        <p>
        ...
        <ul className=" mx-8 space-y-5 list-disc">
          <li>
            ...
            JOY K MultiServices, 116 Cite Sonatel Zac Mbao, Dakar-Senegal.
          </li>
          <li>
        ...
        <p className="text-test font-bold text-2xl ">Contact Us</p>
        <p>
