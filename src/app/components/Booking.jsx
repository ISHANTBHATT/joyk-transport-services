    ...
    >
      ...
      <div className="flex items-center w-full lg:w-auto">
        <div className="relative w-full lg:w-auto">
          ...
          <input
            className="custom-time-input appearance-none block rounded-lg w-full py-2 px-3 text-gray-400 border lg:border-none focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500"
